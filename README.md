...
The purpose of this program is to crawl the data from Amazon goodreads.com based on any bookshelf you like. (Change the bookshelf name in main.java) And produce a result in html.
